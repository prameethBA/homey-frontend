...
export default class Questioner extends Base {
  ...
  quiz = [
...

    {
      ...
      input: `<input class="answer" type="date" value="${new Date()
        .toISOString()
        .slice(0, 10)}"/>`,
    },
  ...
  async fetchPropertyTypes() {
    ...
    await axios
      ...
      .then((res) => {
        ...
        this._qs(".propertyType") != null
          ? (this._qs(".propertyType").innerHTML = data)
          : null;
...
const elementName = "questioner-comp";
customElements.get(elementName) == undefined
  ? window.customElements.define(elementName, Questioner)
  : null;
