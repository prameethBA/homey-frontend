...
class UI extends Base {
  ...
  connectedCallback(){
    ...
    router.get('/advertisement-settings', async () => {
      await import('./componets/advertisement/advertisement-settings.js')
      this._qs(
        '#mainContainer'
      ).innerHTML = `<advertisement-settings></advertisement-settings>`
    })
